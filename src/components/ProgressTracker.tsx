  ...
  return (
    <div className="bg-gray-900 rounded-xl p-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
        ...
        <div className="p-4 bg-gradient-to-br from-yellow-600 to-orange-600 rounded-lg text-center">
          <div className="text-3xl font-bold text-white">
            {bestTotal > 0 ? formatTime(bestTotal) : '--:--'}
          </div>
          <div className="text-sm text-yellow-100">Best Time</div>
        </div>
        <div className="p-4 bg-gray-800 rounded-lg text-center">
        ...
        <div className="p-4 bg-gray-800 rounded-lg text-center">
          ...
          <div className="text-sm text-gray-400">Full Simulations</div>
        </div>
      </div>

      {/* Station Personal Bests */}
      <div className="mb-8">
        <h3 className="text-lg font-semibold text-white mb-4">Station Personal Bests</h3>
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
          {HYROX_STATIONS.map(station => (
            <div key={station.id} className="p-3 bg-gray-800 rounded-lg">
              <div className="text-sm text-gray-400 mb-1">{station.name}</div>
              ...
              <div className="flex items-center justify-between mb-2">
                <div>
                  <span className="text-white font-medium">
                    {session.type === 'full_simulation' ? 'Full Simulation' : 'Station Practice'}
                  </span>
